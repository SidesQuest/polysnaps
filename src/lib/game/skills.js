export const SKILL_DEFS = [
  {
    ...
    iconFrame: "/assets/icons/cyberpunk-skills/2 Frames/Frame_01.png",
    cost: 1,
    maxLevel: 5,
  ...
  },
  {
    ...
    icon: "👆",
    iconPath: "/assets/icons/cyberpunk-skills/1 Icons/1/Skillicon1_25.png",
    iconFrame: "/assets/icons/cyberpunk-skills/2 Frames/Frame_01.png",
    cost: 1,
    maxLevel: 10,
  ...
  },
  {
    ...
    icon: "🌀",
    iconPath: "/assets/icons/cyberpunk-skills/1 Icons/3/Skillicon3_20.png",
    iconFrame: "/assets/icons/cyberpunk-skills/2 Frames/Frame_04.png",
    cost: 3,
    maxLevel: 5,
    requires: "prod-boost-1",
    effect: { type: "production_mult", resource: "flux", value: 0.3 },
    x: -1,
    y: 1.4,
  ...
  },
  {
    ...
    icon: "🔱",
    iconPath: "/assets/icons/cyberpunk-skills/1 Icons/5/Skillicon5_08.png",
    iconFrame: "/assets/icons/cyberpunk-skills/2 Frames/Frame_05.png",
    cost: 2,
    maxLevel: 5,
  ...
  },
  {
    ...
    icon: "💰",
    iconPath: "/assets/icons/cyberpunk-skills/1 Icons/1/Skillicon1_30.png",
    iconFrame: "/assets/icons/cyberpunk-skills/2 Frames/Frame_01.png",
    cost: 2,
    maxLevel: 5,
    requires: "click-boost",
  ...
  },
  {
    ...
    iconFrame: "/assets/icons/cyberpunk-skills/2 Frames/Frame_03.png",
    cost: 5,
    maxLevel: 5,
    requires: "flux-boost",
    effect: { type: "production_mult", resource: "prisms", value: 0.3 },
    x: -1,
    y: 2.8,
    connects: [],
  },
  {
    ...
    icon: "✨",
    iconPath: "/assets/icons/cyberpunk-skills/1 Icons/9/Skillicon9_20.png",
    iconFrame: "/assets/icons/cyberpunk-skills/2 Frames/Frame_02.png",
    cost: 4,
    maxLevel: 3,
  ...
  },
  {
    ...
    icon: "🎯",
    iconPath: "/assets/icons/cyberpunk-skills/1 Icons/5/Skillicon5_01.png",
    iconFrame: "/assets/icons/cyberpunk-skills/2 Frames/Frame_05.png",
    cost: 2,
    maxLevel: 3,
  ...
  },
  {
    ...
    icon: "🌙",
    iconPath: "/assets/icons/cyberpunk-skills/1 Icons/9/Skillicon9_05.png",
    iconFrame: "/assets/icons/cyberpunk-skills/2 Frames/Frame_02.png",
    cost: 3,
    maxLevel: 3,
    requires: "combo-boost",
    effect: { type: "offline_mult", value: 0.2 },
    x: 2,
    y: 4.2,
    connects: [],
  },
...
export function getVisibility(skills) {
  ...
  for (const def of SKILL_DEFS) {
    ...
    for (const otherDef of SKILL_DEFS) {
      ...
      if (
        otherDef.connects.includes(def.id) ||
        def.connects.includes(otherDef.id)
      ) {
        nearUnlocked = true;
        break;
      }
